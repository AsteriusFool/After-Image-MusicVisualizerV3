...
ipcMain.handle('spotify-play', () => spotifyAuth.play());
ipcMain.handle('spotify-pause', () => spotifyAuth.pause());
ipcMain.handle('spotify-next', () => spotifyAuth.next());
ipcMain.handle('spotify-previous', () => spotifyAuth.previous());
ipcMain.handle('spotify-seek', (_event, positionMs) => spotifyAuth.seek(positionMs));
